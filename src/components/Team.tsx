...
const defaultTeamMembers = [
  { id: '1', name: 'Hiroshi Tanaka', role: 'Tech Lead', skills: ['System Design', 'Architecture', 'DevOps', 'Cloud'], avatar_url: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'jp' },
  { id: '2', name: 'Sato Takeru', role: 'Senior Full-Stack & ERP', skills: ['Web', 'ERP Systems', 'Database Design', 'API'], avatar_url: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'jp' },
  { id: '3', name: 'Brian Cui', role: 'Senior IoT Engineer', skills: ['Embedded', 'Cloud Integration', 'Hardware', 'IoT Protocols'], avatar_url: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'cn' },
  { id: '4', name: 'Thong Ng', role: 'Senior Frontend & Mobile Developer', skills: ['iOS', 'Android', 'Cross-platform', 'UI/UX'], avatar_url: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'vn' },
  { id: '5', name: 'Chongzhi Wei', role: 'Senior Backend & ML Engineer', skills: ['Express', 'Django', 'FastAPI', 'Machine Learning'], avatar_url: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'cn' },
  { id: '6', name: 'Yuki Tanaka', role: 'Senior DevOps Engineer', skills: ['Kubernetes', 'AWS', 'CI/CD', 'Terraform'], avatar_url: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'jp' },
  { id: '7', name: 'Akiko Sato', role: 'Senior UX Designer', skills: ['Figma', 'User Research', 'Prototyping', 'Design Systems'], avatar_url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'jp' },
  { id: '8', name: 'Kenji Ito', role: 'Senior Mobile Developer', skills: ['Swift', 'Kotlin', 'React Native', 'Flutter'], avatar_url: 'https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=200&h=200&fit=crop&crop=face', created_at: new Date().toISOString(), country: 'jp' },
];
